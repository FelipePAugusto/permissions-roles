        ...
        <form action="{{route('users.store')}}" method="post">
            ...
            <div class="grid gap-2 grid-cols-2">
                ...
                <div class="mb-3">
                    ...
                    <div class="mt-2">
                        <input type="email" name="email" id="email" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('email')
                        <span class="text-red-500">{{$message}}</span>
                    @enderror
            ...
            <div class="mb-3">
                <label for="role_id">Funções</label>
